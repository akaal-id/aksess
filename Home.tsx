...
import { PageName } from './AksessApp'; // Assuming PageName is in AksessApp or a types file
...
const Home: React.FC<HomeProps> = ({ onNavigate }) => {
  useEffect(() => {
    ...
    // actual navigation is handled in AksessApp.tsx if currentPage is 'home'.
  }, [onNavigate]);

  return (
    <div className="container mx-auto px-4 py-8 text-center">
      <h1 className="text-2xl font-bold text-aksess-navy mb-4">Halaman Beranda (Home)</h1>
      ...
      <button 
        ...
        className="mt-6 bg-aksess-purple text-white font-semibold py-2 px-4 rounded-lg hover:bg-opacity-90 transition-colors"
      >
