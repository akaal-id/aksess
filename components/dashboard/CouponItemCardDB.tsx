      ...
      <div className="p-5">
        <div className="flex justify-between items-start mb-3">
          <div className="flex items-center mr-2">
            <Tag size={20} className="text-aksess-purple mr-2 flex-shrink-0" />
            <h3 className="text-lg font-semibold text-aksess-deep-navy leading-tight truncate" title={coupon.name}>
              {coupon.name}
            </h3>
          </div>
        ...
        <div className="mb-3 p-2 bg-skyblue-50 border border-skyblue-200 rounded-md text-center">
          <p className="text-sm text-skyblue-700">Kode Kupon:</p>
          <p className="text-xl font-bold text-skyblue-800 tracking-wider font-mono">{coupon.code}</p>
        </div>
        ...
        <div className="space-y-1.5 text-sm text-gray-600">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="font-medium text-aksess-purple">{discountDisplay}</span>
          </div>
