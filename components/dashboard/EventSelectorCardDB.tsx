...
const EventSelectorCardDB: React.FC<EventSelectorCardDBProps> = ({ eventData, onSelectEvent }) => {
  ...
  return (
    <div
      className="bg-white rounded-lg border border-gray-200 hover:border-aksess-purple/40 overflow-hidden transition-all duration-300 group flex flex-col h-full shadow-sm hover:shadow-md"
      role="button"
      tabIndex={0}
    ...
    >
      ...
      <div className="p-4 flex flex-col flex-grow">
        <h3
          ...
          className="text-md font-semibold text-aksess-deep-navy group-hover:text-aksess-purple transition-colors duration-200 mb-2 truncate"
          title={name}
        >
          {name}
        </h3>
        ...
        <button
          ...
          className="mt-auto w-full bg-aksess-purple/10 text-aksess-purple font-semibold py-2 px-3 rounded-md
                     hover:bg-aksess-purple/20 transition-colors duration-200
