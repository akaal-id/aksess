  ...
  return (
    ...
    >
      <div className="bg-white text-aksess-navy p-6 sm:p-8 rounded-xl shadow-2xl w-full max-w-lg relative transform transition-all duration-300 ease-out scale-95 opacity-0 animate-modal-appear max-h-[90vh] overflow-y-auto custom-scrollbar-modal">
        ...
        <h2 id="add-crew-modal-title" className="text-xl sm:text-2xl font-semibold text-aksess-navy mb-6">
            ...
            <label htmlFor="crew-role" className="block text-sm font-medium text-gray-700 mb-1">Role/Posisi <span className="text-red-500">*</span></label>
             <div className="relative">
              ...
              <input type="text" name="role" id="crew-role" value={formData.role} onChange={handleInputChange} required
                     className={`w-full py-2.5 pl-9 pr-3 bg-white border rounded-lg shadow-sm focus:ring-1 focus:ring-aksess-purple transition-colors placeholder-gray-400 text-sm ${formErrors.role ? 'border-red-500' : 'border-gray-300'}`}
            ...
            <label htmlFor="crew-phoneNumber" className="block text-sm font-medium text-gray-700 mb-1">Nomor Telepon <span className="text-red-500">*</span></label>
             <div className="relative">
                ...
                <input type="tel" name="phoneNumber" id="crew-phoneNumber" value={formData.phoneNumber} onChange={handleInputChange} required
                    className={`w-full py-2.5 pl-9 pr-3 bg-white border rounded-lg shadow-sm focus:ring-1 focus:ring-aksess-purple transition-colors placeholder-gray-400 text-sm ${formErrors.phoneNumber ? 'border-red-500' : 'border-gray-300'}`}
