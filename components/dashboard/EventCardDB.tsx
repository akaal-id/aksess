...
import { EventData, formatEventTime } from '../../AksessApp'; 
...
const EventCardDB: React.FC<EventCardDBProps> = ({
  ...
  const statusColors: { [key: string]: { dot: string; text: string } } = {
    ...
    Draf: { dot: 'bg-skyblue-500', text: 'text-skyblue-700' },
  ...
  return (
    <div 
      className="bg-white rounded-lg border border-gray-200 hover:border-aksess-purple/30 overflow-hidden transition-all duration-300 group flex flex-col h-full"
      role="article" 
      ...
      <div className="p-4 sm:p-5 flex flex-col flex-grow"> {/* Standardized padding */}
        ...
        <div className="flex justify-between items-center mb-2">
          <h3 
            ...
            className="text-lg font-semibold text-aksess-deep-navy group-hover:text-aksess-purple transition-colors duration-200 truncate flex-grow mr-2" 
            title={name}
          >
            {name}
          </h3>
        ...
        <div className="mt-auto pt-3 text-center">
          <button
            ...
            className="text-sm font-semibold text-aksess-purple hover:text-aksess-skyblue transition-colors duration-200 py-1 group/button inline-flex items-center"
