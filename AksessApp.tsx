...
const sampleEventsInitial: (Omit<EventData, "ticketCategories"> & {
  ...
  },
  {
    ...
    organizerName: "Aksess Event Management",
    organizerLogoUrl: "/image/Aksesslogo.png",
    summary:
    ...
    narahubungName: "Tim Aksess Events",
    narahubungPhone: "081211112222",
    narahubungEmail: "events@Aksess.com",
  },
  {
    id: 3,
    category: "B2G",
    ...
    organizerName: "Kementerian Koperasi dan UKM & Aksess",
  ...
  },
  {
    ...
    narahubungName: "Tim Kuliner Aksess",
    narahubungPhone: "081233334444",
    narahubungEmail: "foodfest@Aksess.com",
  },
  {
    id: 101,
    category: "B2C",
  ...
  },
  {
    id: 15,
    category: "B2C",
    name: "Aksess E-Champions Cup 2025",
    ...
    organizerName: "Aksess Gaming Division",
    organizerLogoUrl: "/image/Aksesslogo.png",
    summary:
    ...
    eventSlug: "Aksess-echampions-cup-2025",
    narahubungName: "Panitia E-Sport Aksess",
    narahubungPhone: "089988887777",
    narahubungEmail: "esports@Aksess.com",
  },
];
...
const AksessApp: React.FC = () => {
  ...
  const handleNavigateRequestWithConfirmation = useCallback(
    (targetPage: PageName, targetData?: any, resetCallback?: () => void) => {
      ...
      let iconColor = "text-skyblue-500";
      let confirmBtnClass = "bg-skyblue-500 hover:bg-skyblue-600 text-white";
  ...
  const handleLogout = () => {
    const logoutConfig = {
      ...
      cancelText: "Batal",
      icon: AlertTriangle,
      iconColorClass: "text-skyblue-500",
      confirmButtonClass: "bg-skyblue-500 hover:bg-skyblue-600 text-white",
    };
  ...
  const handleSwitchRole = (newRole: UserRole) => {
    if (newRole === "organization") {
      ...
      handleLogin(
        newRole,
        newRole === "creator" ? "Kreator Aksess" : "Pengunjung Aksess"
      );
      setIsRoleSwitchModalOpen(false);
    }
  };
  ...
  const handleProcessPayment = (
    ...
    const newTransactionId = `TRX-Aksess-${Date.now().toString().slice(-8)}`;
  ...
  return (
    <>
      ...
      <style>{`
        body {
          background-color: #FEFFFF; /* aksess-light-bg */
          color: #18093B; /* aksess-deep-navy */
        }
      `}</style>
    </>
  );
