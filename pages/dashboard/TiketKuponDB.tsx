...
import { EventData, TicketCategory, formatEventTime } from '../../AksessApp';
...
const TiketKuponDB: React.FC<TiketKuponDBProps> = ({ allEvents, currentEventContext, onSetContextEvent, onSwitchView }) => {
  ...
  return (
    <div className="p-0 sm:p-2 md:p-4 bg-gray-50 min-h-full space-y-2">
      <h1 className="text-2xl sm:text-3xl font-bold text-aksess-deep-navy">Manajemen Tiket & Kupon</h1>
      <p className="text-sm text-gray-600 mb-6">
        Event: <strong className="text-aksess-purple">{currentEventContext.name}</strong>
      </p>
        ...
        <nav className="-mb-px flex space-x-6" aria-label="Tabs">
            <button
              ...
              className={`whitespace-nowrap py-3 px-1 border-b-2 font-medium text-sm
                  ${activeTab === 'tiket'
                  ? 'border-aksess-purple text-aksess-purple'
          ...
          <div className="flex items-center gap-4">
            <div className="relative flex-grow">
              ...
              <input
                ...
                className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-aksess-purple/20 focus:border-aksess-purple/50 text-sm bg-white"
              />
            </div>
            <button
              onClick={handleAddTicketClick}
              className="bg-aksess-purple text-white font-semibold py-2 px-4 rounded-lg hover:bg-opacity-90 transition-colors flex items-center gap-2 text-sm flex-shrink-0"
            >
        ...
        <div className="space-y-6 bg-white p-4 rounded-b-lg border border-t-0 border-gray-200">
           <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="bg-aksess-purple text-white font-semibold py-2 px-4 rounded-lg transition-colors flex items-center gap-2 text-sm flex-shrink-0 hover:bg-opacity-90"
            >
