...
import { PageName, EventData, formatEventTime } from '../../AksessApp'; // Assuming EventData and PageName are here
...
export const sampleOrders: OrderItem[] = [
  {
    id: 'ORD-2024001', transactionId: 'TRX-Aksess-A1B2C3D4', eventId: 1, eventName: 'Local Soundscape: Indie Music Night',
  ...
  { 
    id: 'ORD-2024002', transactionId: 'TRX-Aksess-E5F6G7H8', eventId: 2, eventName: 'Creator Connect 2025', // Kreator Aksess Event
  ...
  { 
    id: 'ORD-2024003', transactionId: 'TRX-Aksess-I9J0K1L2', eventId: 11, eventName: 'Indonesia Future Tech Summit', // Organisasi Aksess Event
  ...
  {
    id: 'ORD-2024004', transactionId: 'TRX-Aksess-M3N4O5P6', eventId: 14, eventName: 'Cita Rasa Nusantara Food Festival',
  ...
  { 
    id: 'ORD-2024005', transactionId: 'TRX-Aksess-Q7R8S9T0', eventId: 15, eventName: 'Aksess E-Champions Cup 2025', // Kreator Aksess Event
  ...
  { 
    id: 'ORD-2024006', transactionId: 'TRX-Aksess-K4B5C6D7', eventId: 12, eventName: 'Karya Anak Bangsa Expo 2025', // Organisasi Aksess Event
  ...
  ...Array.from({ length: 14 }, (_, i) => { 
    const eventOptions = [
        ...
        {id: 15, name: 'Aksess E-Champions Cup 2025', date: '2025/12/01 - 2025/12/15', time: 'Sesuai Jadwal Pertandingan', loc: 'Online & BritAma Arena, Jakarta', ticketCat: 'Spectator-venue-gf', price: 100000},
    ...
    return {
        id: `ORD-202400${i + 7}`, transactionId: `TRX-Aksess-U${i}V${i+1}W${i+2}X${i+3}`,
  ...
  {
    id: 'ORD-2024021', transactionId: 'TRX-Aksess-NEW00001', eventId: 101, eventName: 'Jakarta Culinary Expo 2025',
  ...
  {
    id: 'ORD-2024022', transactionId: 'TRX-Aksess-NEW00002', eventId: 105, eventName: 'Surabaya Marathon 2025',
  ...
  {
    id: 'ORD-2024023', transactionId: 'TRX-Aksess-NEW00003', eventId: 1, eventName: 'Local Soundscape: Indie Music Night',
    eventDateDisplay: '2025/06/28 - 2025/06/29', eventTimeDisplay: '15:00 - 22:00', eventTimezone: 'WIB', eventLocation: 'Rooftop ITC Depok',
  ...
  {
    id: 'ORD-2024024', transactionId: 'TRX-Aksess-NEW00004', eventId: 107, eventName: 'Anime & Cosplay Festival "Nippon Vibes"',
  ...
  {
    id: 'ORD-2024025', transactionId: 'TRX-Aksess-NEW00005', eventId: 4, eventName: 'Pameran Seni Kontemporer "RuangRupa"',
  ...
  {
    id: 'ORD-2024026', transactionId: 'TRX-Aksess-NEW00006', eventId: 102, eventName: 'ASEAN Startup Summit 2026',
  ...
  {
    id: 'ORD-2024027', transactionId: 'TRX-Aksess-NEW00007', eventId: 14, eventName: 'Cita Rasa Nusantara Food Festival',
    eventDateDisplay: '2025/09/20 - 2025/09/22', eventTimeDisplay: '11:00 - 21:00', eventTimezone: 'WIB', eventLocation: 'Lapangan Banteng, Jakarta',
  ...
  {
    id: 'ORD-2024028', transactionId: 'TRX-Aksess-NEW00008', eventId: 103, eventName: 'Bandung Creative Week 2025',
  ...
  {
    id: 'ORD-2024029', transactionId: 'TRX-Aksess-NEW00009', eventId: 1, eventName: 'Local Soundscape: Indie Music Night',
    eventDateDisplay: '2025/06/28 - 2025/06/29', eventTimeDisplay: '15:00 - 22:00', eventTimezone: 'WIB', eventLocation: 'Rooftop ITC Depok',
  ...
  {
    id: 'ORD-2024030', transactionId: 'TRX-Aksess-NEW00010', eventId: 101, eventName: 'Jakarta Culinary Expo 2025',
    eventDateDisplay: '2025/11/01 - 2025/11/03', eventTimeDisplay: '10:00 - 21:00', eventTimezone: 'WIB', eventLocation: 'JIExpo Kemayoran',
  ...
  {
    id: 'ORD-2024031', transactionId: 'TRX-Aksess-NEW00011', eventId: 105, eventName: 'Surabaya Marathon 2025',
    eventDateDisplay: '2025/08/17', eventTimeDisplay: '05:00 - 10:00', eventTimezone: 'WIB', eventLocation: 'Balai Kota Surabaya',
  ...
  {
    id: 'ORD-2024032', transactionId: 'TRX-Aksess-NEW00012', eventId: 15, eventName: 'Aksess E-Champions Cup 2025',
    eventDateDisplay: '2025/12/01 - 2025/12/15', eventTimeDisplay: 'Sesuai Jadwal Pertandingan', eventTimezone: 'WIB', eventLocation: 'Online & BritAma Arena, Jakarta',
  ...
  {
    id: 'ORD-2024033', transactionId: 'TRX-Aksess-NEW00013', eventId: 4, eventName: 'Pameran Seni Kontemporer "RuangRupa"',
    eventDateDisplay: '2025/09/05 - 2025/09/15', eventTimeDisplay: '10:00 - 19:00', eventTimezone: 'WIB', eventLocation: 'Galeri Nasional Indonesia, Jakarta',
   ...
   {
    id: 'ORD-2024034', transactionId: 'TRX-Aksess-NEW00014', eventId: 101, eventName: 'Jakarta Culinary Expo 2025',
    eventDateDisplay: '2025/11/01 - 2025/11/03', eventTimeDisplay: '10:00 - 21:00', eventTimezone: 'WIB', eventLocation: 'JIExpo Kemayoran',
  ...
  {
    id: 'ORD-2024035', transactionId: 'TRX-Aksess-NEW00015', eventId: 107, eventName: 'Anime & Cosplay Festival "Nippon Vibes"',
    eventDateDisplay: '2025/12/06 - 2025/12/07', eventTimeDisplay: '11:00 - 20:00', eventTimezone: 'WIB', eventLocation: 'Mall @ Alam Sutera, Tangerang',
  ...
  {
    id: 'ORD-2024036', transactionId: 'TRX-Aksess-NEW00016', eventId: 1, eventName: 'Local Soundscape: Indie Music Night',
    eventDateDisplay: '2025/06/28 - 2025/06/29', eventTimeDisplay: '15:00 - 22:00', eventTimezone: 'WIB', eventLocation: 'Rooftop ITC Depok',
  ...
  {
    id: 'ORD-2024037', transactionId: 'TRX-Aksess-NEW00017', eventId: 102, eventName: 'ASEAN Startup Summit 2026',
    eventDateDisplay: '2026/03/15 - 2026/03/17', eventTimeDisplay: '09:00 - 18:00', eventTimezone: 'WITA', eventLocation: 'Bali International Convention Centre',
  ...
  {
    id: 'ORD-2024038', transactionId: 'TRX-Aksess-NEW00018', eventId: 105, eventName: 'Surabaya Marathon 2025',
    eventDateDisplay: '2025/08/17', eventTimeDisplay: '05:00 - 10:00', eventTimezone: 'WIB', eventLocation: 'Balai Kota Surabaya',
  ...
  {
    id: 'ORD-2024039', transactionId: 'TRX-Aksess-NEW00019', eventId: 14, eventName: 'Cita Rasa Nusantara Food Festival',
    eventDateDisplay: '2025/09/20 - 2025/09/22', eventTimeDisplay: '11:00 - 21:00', eventTimezone: 'WIB', eventLocation: 'Lapangan Banteng, Jakarta',
  ...
  {
    id: 'ORD-2024040', transactionId: 'TRX-Aksess-NEW00020', eventId: 4, eventName: 'Pameran Seni Kontemporer "RuangRupa"',
    eventDateDisplay: '2025/09/05 - 2025/09/15', eventTimeDisplay: '10:00 - 19:00', eventTimezone: 'WIB', eventLocation: 'Galeri Nasional Indonesia, Jakarta',
...
const PesananDB: React.FC<PesananDBProps> = ({ allCreatorEvents, selectedEvent, onBackToEventList, onNavigate }) => {
  ...
  const summaryCards = [
    ...
    { title: 'Total Kupon Terpakai', value: totalKuponTerpakai.toLocaleString('id-ID'), dotColor: 'bg-skyblue-500' },
  ];
      ...
      <div className="mt-8 flex flex-col sm:flex-row justify-between items-center text-sm text-gray-600 bg-white p-4 rounded-b-lg border-t border-gray-200">
        ...
        <div className="flex items-center space-x-1">
          <button
            ...
            className="px-3 py-1.5 rounded-md bg-white text-gray-500 hover:bg-gray-100 border border-gray-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center focus:ring-2 focus:ring-aksess-purple/20 focus:border-aksess-purple/50"
          ...
          {pageNumbers.map((number, index) =>
            typeof number === 'string' ? (
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-md transition-colors border focus:ring-2 focus:ring-aksess-purple/20 focus:border-aksess-purple/50
                  ${currentPage === number 
                    ? 'bg-aksess-purple text-white font-semibold border-aksess-purple' 
  ...
  if (!selectedEvent) {
    return (
      <div className="p-0 sm:p-2 md:p-4 bg-gray-50 min-h-full space-y-6 text-center">
        <ArrowLeftIcon
          size={48}
          className="mx-auto text-gray-400 my-6 cursor-pointer hover:text-aksess-purple"
          onClick={onBackToEventList}
          aria-label="Kembali ke daftar event"
          role="button"
        />
        <h1 className="text-xl font-semibold text-aksess-deep-navy">Pilih Event Terlebih Dahulu</h1>
        <p className="text-gray-600 mb-6">Untuk melihat daftar pesanan, silakan pilih event dari daftar event utama.</p>
        <button
            onClick={onBackToEventList}
            className="bg-aksess-purple text-white font-semibold py-2.5 px-6 rounded-lg hover:bg-opacity-90 transition-colors flex items-center gap-2 mx-auto"
        >
  ...
  return (
    <div className="p-0 sm:p-2 md:p-4 bg-gray-50 min-h-full">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
        <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-aksess-deep-navy">Daftar Pesanan</h1>
            <p className="text-sm text-gray-600 mt-1">
              Event: <strong className="text-aksess-purple">{selectedEvent.name}</strong>
            </p>
        </div>
        {/* <button
            onClick={onBackToEventList}
            className="text-sm text-aksess-purple hover:text-aksess-navy font-semibold transition-colors group flex items-center mt-3 sm:mt-0"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
          <div className="lg:col-span-2">
            ...
            <div className="relative">
              ...
              <input type="text" id="search-order" placeholder="ID, Nama, Email..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="w-full pl-9 pr-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-aksess-purple focus:border-aksess-purple bg-white"/>
            </div>
          </div>
          <div>
            <label htmlFor="filter-status" className="block text-xs font-medium text-gray-600 mb-1">Status Pesanan</label>
            <select id="filter-status" value={filterStatus} onChange={e => setFilterStatus(e.target.value)} className="w-full py-2 px-3 text-sm border border-gray-300 rounded-lg focus:ring-aksess-purple focus:border-aksess-purple appearance-none bg-white">
           ...
           <div>
            ...
            <select id="filter-gender-order" value={filterGender} onChange={e => setFilterGender(e.target.value)} className="w-full py-2 px-3 text-sm border border-gray-300 rounded-lg focus:ring-aksess-purple focus:border-aksess-purple appearance-none bg-white">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {currentDisplayOrders.length > 0 ? currentDisplayOrders.map(order => (
              <tr key={order.id} className="hover:bg-gray-50 transition-colors">
                ...
                <td className="px-4 py-3 text-xs whitespace-nowrap"><span className={`px-2 py-0.5 inline-flex text-xs leading-5 font-semibold rounded-full ${order.status === 'Berhasil' ? 'bg-green-100 text-green-800' : order.status === 'Pending' ? 'bg-skyblue-100 text-skyblue-800' : 'bg-red-100 text-red-800'}`}>{order.status}</span></td>
                ...
                <td className="px-4 py-3 text-xs text-center whitespace-nowrap">
                    <button onClick={() => handleOpenEditStatusModal(order)} className="text-gray-400 hover:text-aksess-purple p-1" aria-label="Edit Status Pesanan">
                        <Edit2 size={14} />
                    </button>
                </td>
              </tr>
