...
import { CheckoutInfo, PageName, TransactionFormData, EventData, formatEventTime } from '../AksessApp'; // Renamed import
...
const CheckoutPage: React.FC<CheckoutPageProps> = ({ checkoutInfo, eventForBackNav, onNavigate, onProcessPayment }) => {
  ...
  const handleConfirmAndPay = () => {
    ...
    // Call the new prop function to initiate payment processing in AksessApp
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-6">
          <button
            ...
            className="flex items-center text-sm text-aksess-purple hover:text-aksess-navy font-semibold transition-colors group"
          >
        ...
        <header className="text-center mb-8 md:mb-12">
          <h1 className="text-3xl md:text-4xl font-bold text-aksess-navy">Konfirmasi Pesanan Anda</h1>
          <p className="mt-2 text-lg text-gray-600">Silakan periksa detail pesanan Anda dan lengkapi data diri.</p>
        </header>

        <div className="lg:flex lg:gap-8">
          <div className="hidden lg:block lg:w-1/3 bg-white rounded-xl border border-aksess-navy/10 mb-8 lg:mb-0 lg:sticky lg:top-24 self-start overflow-hidden">
            ...
            <div className="p-6">
              <h2 className="text-2xl font-semibold text-aksess-navy mb-6 border-b pb-3 flex items-center">
                <TicketIcon size={24} className="mr-3 text-aksess-purple" />
                Detail Tiket
              </h2>
              
              <div className="mb-6">
                <h3 className="text-xl font-semibold text-aksess-navy mb-2">{event.name}</h3>
                <div className="flex items-center text-sm text-gray-600 mb-1">
                  <CalendarDays size={16} className="mr-2 text-aksess-purple" />
                  <span>{event.dateDisplay}</span>
                </div>
                <div className="flex items-center text-sm text-gray-600 mb-1">
                  <Clock size={16} className="mr-2 text-aksess-purple" />
                  <span>{formatEventTime(event.timeDisplay, event.timezone)}</span>
                </div>
                <div className="flex items-center text-sm text-gray-600">
                  <MapPin size={16} className="mr-2 text-aksess-purple" />
                  <span>{event.location}</span>
                </div>
              </div>

              <div className="space-y-3 mb-6">
                <h4 className="text-md font-semibold text-aksess-navy">Tiket yang Dipilih:</h4>
              ...
              <div className="mb-6 border-t pt-4">
                ...
                <div className="flex gap-2 items-center">
                  <input
                    ...
                    className="flex-grow py-2 px-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-aksess-purple/20 focus:border-aksess-purple/50 transition-colors text-sm bg-white"
                  />
                  <button
                    type="button"
                    onClick={handleApplyCoupon}
                    aria-label="Terapkan kupon"
                    className="bg-aksess-purple text-white p-2 rounded-lg hover:bg-opacity-90 transition-colors"
                  >
                    <Tag size={20} />
                  </button>
                </div>
              ...
              <div className="border-t pt-4">
                ...
                <div className="flex justify-between items-center text-lg font-bold mt-1">
                  <span className="text-aksess-navy">Total Pembayaran:</span>
                  <span className="text-aksess-skyblue">{formatCurrency(effectiveTotalPrice)}</span>
                </div>
              </div>
            </div>
          </div>

          <form onSubmit={handleSubmit} id="checkoutForm" className="lg:w-2/3 bg-white p-6 md:p-8 rounded-xl border border-aksess-navy/10">
            <div className="lg:hidden bg-gray-50 p-4 rounded-lg border border-aksess-navy/10 mb-6">
                <h2 className="text-xl font-semibold text-aksess-navy mb-4 border-b pb-2 flex items-center">
                    <TicketIcon size={22} className="mr-2 text-aksess-purple"/>
                    Detail Tiket
                </h2>
                <div className="mb-4">
                    <h3 className="text-lg font-semibold text-aksess-navy mb-1">{event.name}</h3>
                ...
                <div className="space-y-2 mb-4 border-b pb-4">
                    <h4 className="text-sm font-semibold text-aksess-navy">Tiket:</h4>
                    {selectedTickets.map(ticket => (
            ...
            <h2 className="text-2xl font-semibold text-aksess-navy mb-6 border-b pb-3">Data Pemesan</h2>
            <div className="space-y-6">
              <div>
                ...
                <div className="relative mt-1">
                  ...
                  <input 
                    ...
                    className="w-full py-2.5 px-4 pl-10 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-aksess-purple/20 focus:border-aksess-purple/50 transition-colors bg-white" 
                ...
                <label htmlFor="email" className="block text-sm font-medium text-gray-700 mb-1">Alamat Email Aktif</label>
                 <div className="relative mt-1">
                  ...
                  <input 
                    ...
                    className={`w-full py-2.5 px-4 pl-10 border rounded-lg shadow-sm focus:ring-2 focus:ring-aksess-purple/20 focus:border-aksess-purple/50 transition-colors bg-white ${emailError ? 'border-red-500' : 'border-gray-300'}`}
              ...
              <div>
                ...
                <div className="relative flex items-stretch w-full mt-1">
                  <div className="relative">
                    <select 
                      ...
                      className="appearance-none z-10 h-full block w-auto py-2.5 pl-3 pr-8 text-sm text-gray-900 border border-r-0 border-gray-300 rounded-l-lg focus:ring-2 focus:ring-aksess-purple/20 focus:border-aksess-purple/50 bg-white"
                  ...
                  <div className="relative flex-grow">
                    ...
                    <input 
                      ...
                      className={`block w-full py-2.5 pl-10 pr-3 text-sm border rounded-r-lg focus:ring-2 focus:ring-aksess-purple/20 focus:border-aksess-purple/50 focus:z-20 shadow-sm bg-white ${phoneError ? 'border-red-500' : 'border-gray-300'}`}
                ...
                <div className="mt-2 flex items-center">
                    <input type="checkbox" id="isWhatsappActive" name="isWhatsappActive" defaultChecked className="h-4 w-4 text-aksess-purple border-gray-300 rounded focus:ring-aksess-purple/20 cursor-not-allowed" disabled />
                ...
                <div>
                    ...
                    <div className="relative mt-1">
                        ...
                        <select 
                            ...
                            className="w-full py-2.5 px-4 pl-10 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-aksess-purple/20 focus:border-aksess-purple/50 transition-colors appearance-none bg-white"
            ...
            {ticketHoldersData.length > 0 && (
                <div className="mt-8 pt-6 border-t">
                    <h2 className="text-xl font-semibold text-aksess-navy mb-4">Data Pemegang Tiket</h2>
                    {ticketHoldersData.map((holder, index) => (
                        <div key={index} className="mb-6 p-4 border border-gray-200 rounded-lg bg-white">
                            <div className="flex justify-between items-center mb-3">
                                <h3 className="text-md font-semibold text-aksess-navy">
                                ...
                                <label htmlFor={`syncData-${index}`} className="flex items-center cursor-pointer">
                                  <div className="relative">
                                    ...
                                    />
                                    <div className="w-10 h-6 bg-gray-300 rounded-full peer-checked:bg-aksess-purple transition-colors"></div>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                      ...
                                      <input 
                                        ...
                                        className="w-full py-2 px-3 pl-9 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-aksess-purple/20 focus:border-aksess-purple/50 text-sm disabled:bg-white disabled:text-gray-500 bg-white"
            ...
            <div className="pt-6 border-t mt-6">
                 <h3 className="text-lg font-semibold text-aksess-navy mb-3">Metode Pembayaran</h3>
                 ...
                 <div className="p-4 bg-gray-100 rounded-lg flex items-center gap-3 border border-gray-200">
                    <CreditCard size={24} className="text-aksess-purple flex-shrink-0"/>
            ...
            <p className="text-xs text-gray-500 mb-4">
                Dengan mengklik tombol di bawah, Anda menyetujui <a href="#" className="text-aksess-purple hover:underline">Syarat & Ketentuan Pembelian Tiket</a> dan <a href="#" className="text-aksess-purple hover:underline">Kebijakan Privasi</a> Aksess.
            </p>
            <button 
                type="submit"
                className="w-full bg-aksess-skyblue text-aksess-navy font-bold py-3.5 px-4 rounded-lg hover:bg-opacity-90 transition-colors flex items-center justify-center gap-2 text-lg focus:outline-none focus:ring-2 focus:ring-aksess-navy focus:ring-offset-2 shadow-md hover:shadow-lg transform hover:scale-105"
            >
        ...
        <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white p-3 border-t border-gray-200 shadow-lg">
            <div className="flex justify-between items-center mb-2">
                <div>
                    ...
                    <p className="text-lg font-bold text-aksess-skyblue">{formatCurrency(effectiveTotalPrice)}</p>
                </div>
                 {couponApplied && discountedPrice !== null && (
            ...
            <div className="flex gap-2 mb-2.5 items-center">
                <input
                    ...
                    className="flex-grow py-2 px-2.5 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-aksess-purple/20 focus:border-aksess-purple/50 text-xs bg-white"
                ...
                <button
                    ...
                    onClick={handleApplyCoupon}
                    aria-label="Terapkan kupon"
                    className="bg-aksess-purple text-white p-1.5 rounded-md hover:bg-opacity-90"
                >
                    <Tag size={18} />
                </button>
            </div>
            ...
            <button
                type="submit"
                form="checkoutForm"
                className="w-full bg-aksess-skyblue text-aksess-navy font-bold py-3 px-5 rounded-lg hover:bg-opacity-90 transition-colors flex items-center justify-center gap-2 text-sm"
            >
                <ShoppingCart size={18} />
                Lanjutkan ke Pembayaran
            </button>
            <p className="text-[10px] text-gray-400 mt-1.5 text-center">
                Dengan melanjutkan, Anda menyetujui S&K Aksess.
            </p>
        </div>
    </div>
  );
