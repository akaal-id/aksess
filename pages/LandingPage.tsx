...
import { PageName, EventData } from '../AksessApp'; // Renamed import
...
const LandingPage: React.FC<LandingPageProps> = ({ heroEvents, featuredEvents, onNavigate, onOpenLoginModal }) => {
  ...
  const handleNewsletterSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (emailInput && emailInput.value) {
      alert(`Terima kasih! Email ${emailInput.value} telah didaftarkan untuk newsletter Aksess.`);
  ...
  return (
    <>
      ...
      <section id="events" className="py-16 md:py-24 bg-aksess-card-bg animate-on-scroll fade-in" ref={addToRefs}>
        <div className="container mx-auto px-0 sm:px-6 lg:px-8"> {/* Adjusted padding for full-bleed scroll */}
          <div className="flex flex-col md:flex-row justify-between items-center mb-10 md:mb-16  px-4 sm:px-0"> {/* Padding for title section */}
            <div>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-aksess-deep-navy text-center md:text-left">Temukan Event <span className="text-gradient">Menarik</span></h2>
              <p className="text-neutral-700 mt-2 text-center md:text-left">Jelajahi berbagai acara terbaru dan paling populer.</p>
            </div>
            <button 
              onClick={() => onNavigate('events')} 
              className="mt-4 md:mt-0 text-aksess-gradient-start hover:text-aksess-gradient-mid font-semibold transition-colors duration-300 group flex items-center"
            >
      ...
      {/* Section 3: About Aksess - Reconstructed */}
      <section id="about-Aksess" className="py-16 md:py-24 bg-aksess-chino/20 animate-on-scroll fade-in" ref={addToRefs}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-4">
            <span className="bg-aksess-purple/20 text-aksess-purple font-semibold px-4 py-1.5 rounded-full text-xs inline-block">
              ABOUT US
            </span>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold text-aksess-deep-navy mb-8">
            Apa itu <span className="text-aksess-purple">Aksess?</span>
          </h2>
          ...
          <div className="md:grid md:grid-cols-2 md:gap-x-12 lg:gap-x-16 mb-12 text-gray-700 text-base md:text-lg leading-relaxed space-y-4 md:space-y-0">
            <p>
              Aksess adalah platform event terintegrasi yang dirancang untuk merevolusi cara Anda menemukan, mengelola, dan menikmati berbagai acara. Kami percaya bahwa setiap event adalah sebuah kesempatan—untuk belajar, bertumbuh, berjejaring, dan menciptakan kenangan.
            </p>
            <p>
              Misi kami adalah memberdayakan penyelenggara event dengan alat yang intuitif dan komprehensif, sekaligus memberikan pengalaman yang mulus dan menyenangkan bagi para peserta. Dari konser musik megah hingga workshop bisnis yang intim, Aksess hadir untuk Anda.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-8 mb-12 md:mb-16 ">
            <FeatureItem
              ...
              iconBgClass="bg-aksess-purple/20"
              iconColorClass="text-aksess-purple"
            />
            <FeatureItem
              icon={Users}
              title="Jangkauan Luas"
              description="Temukan audiens yang lebih luas untuk event Anda atau jelajahi ribuan event menarik di seluruh Indonesia."
              iconBgClass="bg-aksess-skyblue/20"
              iconColorClass="text-aksess-skyblue"
            />
            <FeatureItem
              icon={Briefcase}
              ...
              iconBgClass="bg-aksess-chino/20"
              iconColorClass="text-aksess-chino"
            />
          </div>
          ...
          <img
            ...
            alt="Aksess - Connecting Visions and Solutions"
      ...
      <section id="business-matching" className="py-16 md:py-24 bg-aksess-card-bg animate-on-scroll fade-in" ref={addToRefs}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 md:mb-16 ">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-aksess-deep-navy">Jalin Koneksi <span className="text-gradient">Bisnis Strategis</span></h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
           ...
           <div className="text-center mt-12 md:mt-16 ">
            <button 
                ...
                className="bg-aksess-purple text-white font-semibold py-3 px-8 rounded-lg hover:bg-opacity-90 transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-aksess-skyblue focus:ring-offset-2 shadow-md hover:shadow-lg"
            >
      ...
      <section id="articles" className="py-16 md:py-24 bg-aksess-chino/20 animate-on-scroll fade-in" ref={addToRefs}>
        <div className="container mx-auto px-0 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center mb-10 md:mb-16 px-4 sm:px-0">
            <div>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-aksess-deep-navy text-center md:text-left">
      ...
      <section id="newsletter" className="py-16 md:py-24 bg-gradient-to-b from-aksess-purple/60 to-aksess-purple text-aksess-white" ref={addToRefs}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className=" ">
            <Mail size={48} className="mx-auto mb-4" />
            <h2 className="text-3xl md:text-4xl font-bold mb-3">Tetap Terhubung!</h2>
            <p className="text-lg opacity-90 mb-8 max-w-xl mx-auto">
              Dapatkan berita terbaru, promo eksklusif, dan info event pilihan dari Aksess langsung ke kotak masuk Anda.
            </p>
            <form 
            ...
            >
              ...
              <input
                ...
                required
                className="w-full sm:flex-grow py-3 px-5 rounded-lg text-aksess-deep-navy placeholder-gray-500 focus:ring-2 focus:ring-aksess-skyblue focus:outline-none transition-shadow shadow-sm bg-white"
                aria-label="Alamat email untuk newsletter"
              />
              <button
                type="submit"
                className="w-full sm:w-auto bg-aksess-skyblue text-aksess-navy font-semibold py-3 px-8 rounded-lg hover:bg-opacity-90 transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-aksess-navy focus:ring-offset-2 focus:ring-offset-aksess-purple shadow-md"
              >
                Berlangganan
              </button>
            </form>
