...
import { PageName, UserRole } from '../AksessApp';
...
const PortfolioCard: React.FC<PortfolioCardProps> = ({ imageUrl, eventName, description }) => (
  <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
    ...
    <div className="p-6">
      <h4 className="text-xl font-semibold text-aksess-navy mb-2">{eventName}</h4>
...
const CreatorFeatureCard: React.FC<CreatorFeatureCardProps> = ({ icon: Icon, title, description }) => (
  <div className="bg-gradient-to-br from-aksess-purple/5 to-aksess-skyblue/5 p-6 rounded-xl border border-aksess-purple/20 text-center hover:shadow-lg transition-shadow duration-300">
    <div className="inline-block p-4 bg-aksess-purple text-white rounded-full mb-4">
      <Icon size={32} />
    </div>
    <h4 className="text-lg font-semibold text-aksess-navy mb-2">{title}</h4>
...
const CreateEventInfoPage: React.FC<CreateEventInfoPageProps> = ({ 
  ...
  return (
    <div className="bg-aksess-light-bg">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-aksess-navy to-aksess-purple py-20 md:py-32 text-white text-center animate-on-scroll fade-in-up" ref={addToRefs}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 ">
          <Zap size={64} className="mx-auto mb-6 text-aksess-skyblue" />
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">Wujudkan Event <span className="text-aksess-skyblue">Impian Anda</span></h1>
          <p className="text-lg md:text-xl opacity-90 max-w-3xl mx-auto mb-8">
            aksess menyediakan platform lengkap untuk membantu Anda merencanakan, mempromosikan, dan mengelola event dengan sukses dan mudah.
          </p>
          <button 
            onClick={handleCTAClick}
            className="bg-aksess-skyblue text-aksess-navy font-bold py-3 px-8 rounded-lg text-lg hover:bg-opacity-90 transition-all duration-300 transform hover:scale-105 shadow-xl"
          >
            {ctaButtonText}
          </button>
        </div>
      ...
      {/* About aksess for Creators Section */}
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 ">
      <section className="py-16 md:py-24 bg-aksess-white " ref={addToRefs}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 ">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-aksess-deep-navy">
              Mengapa Memilih <span className="text-aksess-purple">aksess</span> untuk Event Anda?
            </h2>
      ...
      <section className="py-16 md:py-24 bg-gray-50 animate-on-scroll fade-in" ref={addToRefs}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 ">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-lg text-gray-600 mt-3 max-w-2xl mx-auto">
              Lihat bagaimana aksess telah membantu berbagai event mencapai kesuksesan.
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-aksess-white animate-on-scroll fade-in" ref={addToRefs}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 ">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-aksess-deep-navy">
              Fitur <span className="text-aksess-purple">Unggulan</span> Platform Kami
            </h2>
            <p className="text-lg text-gray-600 mt-3 max-w-2xl mx-auto">
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-aksess-chino/20 to-aksess-chino/50 animate-on-scroll fade-in" ref={addToRefs}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center ">
          <Award size={48} className="mx-auto mb-6 text-aksess-skyblue" />
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-aksess-deep-navy mb-4">
            Langkah Mudah Membuat Event Anda di aksess
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-left max-w-4xl mx-auto mb-12">
            <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-aksess-purple">
              <h3 className="text-xl font-semibold text-aksess-navy mb-2"><span className="text-aksess-purple font-bold text-2xl mr-2">1.</span>Daftar Akun</h3>
              <p className="text-sm text-gray-600">Buat akun Event Creator atau Organisasi Anda di aksess. Prosesnya cepat dan mudah.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-aksess-skyblue">
              <h3 className="text-xl font-semibold text-aksess-navy mb-2"><span className="text-aksess-skyblue font-bold text-2xl mr-2">2.</span>Buat Event</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-aksess-navy">
              <h3 className="text-xl font-semibold text-aksess-navy mb-2"><span className="text-aksess-navy font-bold text-2xl mr-2">3.</span>Publikasi & Kelola</h3>
          ...
          <button
            onClick={handleCTAClick}
            className="bg-aksess-purple text-white font-bold py-4 px-10 rounded-lg text-lg hover:bg-opacity-90 transition-all duration-300 transform hover:scale-105 shadow-xl flex items-center justify-center gap-2 mx-auto"
          >
